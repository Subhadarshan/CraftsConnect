...
export default function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center bg-gradient-to-tr from-emerald-100 via-teal-50 to-emerald-200 text-gray-900">
      {/* Main Content */}
      <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 px-6 pt-24 md:pt-32">
        ...
        <div className="md:w-2/3 text-left md:text-left text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight mb-4">
            Grow your <span className="text-emerald-600">craft business</span> <br />
  ...
  View All Artisans
      ...
      <div className="relative z-10 max-w-6xl mx-auto mt-20 px-6">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div className="p-6 bg-emerald-100/80 backdrop-blur-lg rounded-xl shadow">
            <p className="text-3xl font-bold text-emerald-700">2,000+</p>
          ...
          <div className="p-6 bg-emerald-100/80 backdrop-blur-lg rounded-xl shadow">
            <p className="text-3xl font-bold text-emerald-700">₹10L+</p>
      ...
      <div className="relative z-10 max-w-3xl mx-auto mt-16 px-6">
        <div className="bg-white/90 backdrop-blur-md rounded-xl p-8 shadow text-center">
          ...
          <p className="mt-4 font-semibold text-emerald-700">— Raju, Artisan (Rajasthan)</p>
        </div>
      </div>
          ...
          {["Artisan", "Upload", "AI Generates", "Global Reach"].map((step, i) => (
            <React.Fragment key={i}>
              <div className="flex flex-col items-center flex-1 px-2 mb-6 md:mb-0">
                <div className="mb-2 w-12 h-12 rounded-full bg-emerald-600 text-white flex items-center justify-center text-xl font-bold shadow-lg">
                  {i + 1}
                </div>
                {step}
              </div>
              {i < 3 && (
                <div className="hidden md:block h-1 flex-1 bg-emerald-300 relative top-5 mx-2 rounded-full"></div>
              )}
            </React.Fragment>
          ))}
        </div>
